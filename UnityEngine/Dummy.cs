...
namespace UnityEngine
{
    ...
    public class Canvas
    {
        internal static void ForceUpdateCanvases()
        {
            throw new NotImplementedException();
        }
    }
    ...
    public class Screen
    {
        internal static float width = 1920;
        internal static float height = 1080;
    }
    public enum RuntimePlatform
    {
        Android, WindowsEditor
    }
    ...
    public class Camera
    {
        ...
        internal Vector3 WorldToScreenPoint(Vector3 position)
        {
            throw new NotImplementedException();
        }
    }
    ...
    public class WaitForSeconds(float sec)
    {
        public float sec = sec;
    }
    public class WaitForSecondsRealtime(float sec)
    {
        public float sec = sec;
    }
    public class Animator : Component
    {
        internal AnimatorClipInfo[] GetCurrentAnimatorClipInfo(int v)
        {
            throw new NotImplementedException();
        }

        internal void GetCurrentAnimatorClipInfo(int layer, List<AnimatorClipInfo> clipInfoCache)
        {
            throw new NotImplementedException();
        }

        internal int GetCurrentAnimatorClipInfoCount(int layer)
        {
            throw new NotImplementedException();
        }

        internal AnimatorStateInfo GetCurrentAnimatorStateInfo(int v)
        {
            throw new NotImplementedException();
        }

        internal void GetNextAnimatorClipInfo(int layer, List<AnimatorClipInfo> nextClipInfoCache)
        {
            throw new NotImplementedException();
        }

        internal int GetNextAnimatorClipInfoCount(int layer)
        {
            throw new NotImplementedException();
        }

        internal void Play(object fullPathHash, int v, object value)
        {
            throw new NotImplementedException();
        }
    }
    public class ParticleSystem : MonoBehaviour
    {
        ...
        internal void Play(bool v=false)
        {
            throw new NotImplementedException();
        }

        internal void Simulate(float v1, bool v2, bool v3, bool v4)
        {
            throw new NotImplementedException();
        }
        ...
        {
            internal float startDelayMultiplier;
    ...
    {
        internal static Sprite? Create(Texture2D texture, Rect rect, Vector2 vector2)
        {
            throw new NotImplementedException();
        }
    }
    ...
    {
        [SerializeField] private byte[] m_Script;

        internal string text
        {
            get => Encoding.UTF8.GetString(m_Script);
            set => m_Script = Encoding.UTF8.GetBytes(value);
        }
